...
public class DateUtil {
    ...
    public static final String DATE_FROMAT = "yyyy年MM月";
...
//    }
    ...
    public static boolean isExceedTargetByMillSec(long timestamp, long millSec) {
        long currentDateMills = System.currentTimeMillis();
        System.out.println(timestamp - currentDateMills);
        return ((timestamp - currentDateMills) < (millSec));
    }
...
//    }
    ...
    public static void main(String[] args) {
        long beginTime = DateUtil.parse("2017-10-28 22:2:50", DateUtil.DEFAULT_DATE_TIME).getTime();
